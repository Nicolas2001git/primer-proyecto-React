  ...
  return (
    <div className="pagina">
      ...
      <div className="seccion-personajes-contacto">
        <PersonajeCard imagen={frodo}  titulo="Frodo Bolsón"     descripcion="El portador del Anillo." />
        <PersonajeCard imagen={gollum} titulo="Gollum"           descripcion="Una criatura dividida por el poder del Anillo." />
        <PersonajeCard imagen={gandalf} titulo="Gandalf el Gris" descripcion="El sabio mago guía de la Comunidad." />
      </div>
    </div>
  );
}
